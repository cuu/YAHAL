...
// ---------------------------------------------
//
// Driver for the DAC8311 (TI)
//
#define PCM_FIFO_SIZE 2048

#include "dac8311_rp2350_drv.h"
#include "dac8311.pio.h"

dac8311_rp2350_drv::dac8311_rp2350_drv( gpio_pin_t mosi_pin,
                                        gpio_pin_t sclk_pin,
                                        gpio_pin_t sync_pin,
                                        gpio_pin_t enable)
...
{
    // Set up GPIOs
    gpio_rp2350 mosi( mosi_pin );
    gpio_rp2350 sclk( sclk_pin );
    gpio_rp2350 sync( sync_pin );
    ...
    _pcm_sm = pio_rp2350::pio0.loadProgram(dac8311_program);
...
void dac8311_rp2350_drv::setPcmRate(uint32_t Hz) {
