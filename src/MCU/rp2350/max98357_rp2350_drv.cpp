...
{
    // Set up GPIOs
    gpio_rp2350 din  ( din_pin   );
    gpio_rp2350 bclk ( bclk_pin  );
    gpio_rp2350 lrclk( lrclk_pin );
    ...
    _pcm_sm = pio_rp2350::pio0.loadProgram(max98357_program);
...
void max98357_rp2350_drv::setPcmRate(uint32_t Hz) {
