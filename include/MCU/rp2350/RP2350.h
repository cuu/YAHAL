...
#ifndef _CMSIS_RP2350_H_
#define _CMSIS_RP2350_H_
...
typedef enum {
    ...
    MemoryManagement_IRQn   = -12,          // -12 Memory Management, e.g. MPU mismatch
    BusFault_IRQn           = -11,          // -11 Bus Fault, e.g.Pre-Fetch-, Memory Access Fault
