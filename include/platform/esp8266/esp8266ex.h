...
// Memory layout
////////////////
#define DPORT0		((uint32_t)0x3ff00000)	// dport0 registers
#define MM_IO		((uint32_t)0x60000000)	// Memory Mapped IO

// memory mapped peripherals base addresses
#define UART0_BASE	(MM_IO + 0x000)			// Base address of UART0 module
#define SPI1_BASE	(MM_IO + 0x100)			// Base address of SPI1 module
#define SPI0_BASE	(MM_IO + 0x200)			// Base address of SPI0 module
