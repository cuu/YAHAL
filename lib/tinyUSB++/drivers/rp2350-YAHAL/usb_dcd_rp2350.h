...
// using the YAHAL OS.
//
#ifndef TUPP_USB_DCD_RP2350_H
#define TUPP_USB_DCD_RP2350_H
...
class usb_dcd_rp2350 : public usb_dcd_interface {
public:

    friend class usb_endpoint_rp2350;
    friend void USBCTRL_IRQ_Handler(void);

    static usb_dcd_rp2350 & inst() {
        static usb_dcd_rp2350 _inst;
        return _inst;
    }
