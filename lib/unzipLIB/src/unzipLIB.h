...
class UNZIP {
public:
    int openZIP(const uint8_t *pData, uint32_t iDataSize);

    int openZIP(const char *szFilename, ZIP_OPEN_CALLBACK *pfnOpen, ZIP_CLOSE_CALLBACK *pfnClose,
    ...
    int getFileInfo(unz_file_info *pFileInfo, char *szFileName, int iFilenameBufferSize, void *extraField,
