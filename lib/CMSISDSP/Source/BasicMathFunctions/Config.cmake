...
target_sources(${PROJECT_NAME} PRIVATE ${SRCF16})
endif()
...
target_sources(${PROJECT_NAME} PRIVATE ${SRCU32})
target_sources(${PROJECT_NAME} PRIVATE ${SRCU16})
target_sources(${PROJECT_NAME} PRIVATE ${SRCU8})
