...
target_sources(${PROJECT_NAME} PRIVATE SupportFunctions/arm_barycenter_f32.c
...
target_sources(${PROJECT_NAME} PRIVATE SupportFunctions/arm_copy_f16.c)
target_sources(${PROJECT_NAME} PRIVATE SupportFunctions/arm_fill_f16.c)
target_sources(${PROJECT_NAME} PRIVATE SupportFunctions/arm_f16_to_q15.c)
target_sources(${PROJECT_NAME} PRIVATE SupportFunctions/arm_q15_to_f16.c)
target_sources(${PROJECT_NAME} PRIVATE SupportFunctions/arm_float_to_f16.c)
target_sources(${PROJECT_NAME} PRIVATE SupportFunctions/arm_f16_to_float.c)
target_sources(${PROJECT_NAME} PRIVATE SupportFunctions/arm_weighted_sum_f16.c)
target_sources(${PROJECT_NAME} PRIVATE SupportFunctions/arm_barycenter_f16.c)
target_sources(${PROJECT_NAME} PRIVATE SupportFunctions/arm_f16_to_f64.c)
target_sources(${PROJECT_NAME} PRIVATE SupportFunctions/arm_f64_to_f16.c)
endif()
