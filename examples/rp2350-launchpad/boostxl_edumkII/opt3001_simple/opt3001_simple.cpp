...
// the RP2350. The I2C interface is used to
...
int main()
{
    ...
    // Initialize I2C port
    i2c_rp2350 i2c(EDU_I2C_SDA, EDU_I2C_SCL, 0);
    i2c.setSpeed(400000); // Set speed to 400kHz
