...
// ---------------------------------------------
//
// A small demo for using the adc_rp2350 class.
...
int main() {
    ...
    // ADC channel 0 is joystick X-movement.
    // The voltage from the joystick (range 0...3,3V)
    // is converted to a 12-bit integer (0...4095)
    adc_rp2350_channel joy_X(EDU_JOY_X);
