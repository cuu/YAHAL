...
int main(void)
{
    ...
    task Main( []() {
        ...
        // will output the left/right audio on GPIO19/GPIO21,
        // which fits to the small 3.5mm audio adapter, when
        // connected correctly.
        pcm_pwm_rp2350_drv pcm_if(19, 21);
