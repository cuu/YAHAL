...
// ---------------------------------------------
//
// A simple blink example using two RGB LEDs
...
int main()
{
    ...
    leds[0].set_on_color(0x200000);	// LED0 is red
    leds[1].set_on_color(0x002000);	// LED1 is green

    // Redirect stdout and stderr to our back channel UART,
