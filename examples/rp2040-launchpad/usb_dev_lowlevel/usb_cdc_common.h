...
namespace USB::CDC {
    ...
    ///////////////////////////////
    struct __attribute__((__packed__)) func_desc_header_t : func_device_descriptor_t {
        uint16_t            bcdCDC;
    };
    ...
    //////////////////////////////
    struct __attribute__((__packed__)) func_desc_union_t : func_device_descriptor_t {
    ...
    //////////////////////////////////////////
    struct __attribute__((__packed__)) func_desc_country_selector_t : func_device_descriptor_t {
    ...
    struct __attribute__((__packed__)) func_desc_cm_t : func_device_descriptor_t {
    ...
    struct __attribute__((__packed__)) func_desc_acm_t : func_device_descriptor_t {
    ...
    struct __attribute__((__packed__)) func_desc_direct_line_t  : func_device_descriptor_t {
