 ...
 */
int32_t* _MPU6050_getArrValues(i2c_interface & i2c, uint8_t reg, uint8_t length);
 ...
 */
float _MPU6050_countAccelAngle(i2c_interface & i2c, float a, float b, float c);
 ...
 * @return               calculated angle
 */
float _MPU6050_countGyroAngle(i2c_interface & i2c, float previous_data, int32_t data, int32_t delta);
