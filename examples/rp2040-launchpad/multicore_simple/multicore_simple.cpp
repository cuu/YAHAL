...
// core 1 of the RP2040 MCU. The code on core 1
// is blinking the red LED on the RP2040 Launchpad,
// the code on core 0 is blinking on WS2812 RGB
// LED.
//
#include "board.h"
...
int main()
{
    multicore_rp2040::reset_core1();
    multicore_rp2040::start_on_core1( core1_code );
