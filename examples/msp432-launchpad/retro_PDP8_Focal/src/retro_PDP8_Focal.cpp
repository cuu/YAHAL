...
int main() {
    ...
    gpio_msp432 gpio20(PORT_PIN(2,0));
    gpio_msp432 gpio21(PORT_PIN(2,1));
    gpio_msp432 gpio22(PORT_PIN(2,2));
    gpio20.gpioMode(GPIO::OUTPUT);
    gpio21.gpioMode(GPIO::OUTPUT);
    gpio22.gpioMode(GPIO::OUTPUT);
