...
public:
    ...
    Stepper_28BYJ(gpio_interface & m1, gpio_interface & m2, gpio_interface & m3, gpio_interface & m4)
...
int main(void)
{
    gpio_msp432 m1(PORT_PIN(7, 4));
    gpio_msp432 m2(PORT_PIN(7, 5));
    gpio_msp432 m3(PORT_PIN(7, 6));
    gpio_msp432 m4(PORT_PIN(7, 7));
