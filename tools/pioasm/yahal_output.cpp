...
struct yahal_output : public output_format {
    struct factory {
        factory() {
            output_format::add(new yahal_output());
        }
    };

    yahal_output() : output_format("yahal") {}

    std::string get_description() override {
        return "C header suitable for use with YAHAL";
    }
...
static yahal_output::factory creator;
